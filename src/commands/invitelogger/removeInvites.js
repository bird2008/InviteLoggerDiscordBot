...
const run = async (client, msg, args) => {
    ...
    client.sendDone(`\`\`${amount}\`\` zaproszenia bonusowe zostały wycofane z ${member.user.toString()}.`, msg);
};
module.exports = {
    name: "removeInvites",
    category: "invitelogger",
    description: "Usuwa zaproszenia do członka serwera (jeśli nie podano kwoty lub jeśli kwota jest mniejsza niż 1, kwota jest automatycznie ustawiana na 1).",
